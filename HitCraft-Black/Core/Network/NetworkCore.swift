...
public enum HitCraftNetworkCore {
    ...
    // Extension on the namespaced ApiError
    ...
    public enum Environment {
        ...
        // Auth Configuration
        public static let descopeProjectId = "P2rIvbtGcXTcUfT68LGuVqPitlJd"
        ...
        public enum Endpoint {
            public static let base = "/api/\(Environment.apiVersion)"
            ...
            public static func createChat(artistId: String) -> String { "\(chat)/" }
        }
    }
